...
<Card title="Quick Start Guide" icon="rocket" iconType="light" href="https://docs.peec.ai/quick-start" cta="Let's gooo">
  Everything you need to know to get started with winning in AI search\! 
</Card>